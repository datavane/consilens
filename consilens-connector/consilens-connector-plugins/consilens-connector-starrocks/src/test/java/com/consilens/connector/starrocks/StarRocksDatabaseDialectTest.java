...
/**
 * Unit tests for StarRocksDatabaseDialect.
 */
class StarRocksDatabaseDialectTest {

    private StarRocksDatabaseDialect dialect;

    @BeforeEach
    void setUp() {
        dialect = new StarRocksDatabaseDialect();
    }

    @Test
    void testGetDatabaseType() {
        assertEquals(DatabaseType.STARROCKS, dialect.getDatabaseType());
    }
