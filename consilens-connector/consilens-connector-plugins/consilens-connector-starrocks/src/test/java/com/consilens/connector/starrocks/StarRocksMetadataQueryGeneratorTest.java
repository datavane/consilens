...
/**
 * Unit tests for StarRocksMetadataQueryGenerator.
 */
class StarRocksMetadataQueryGeneratorTest {

    private StarRocksMetadataQueryGenerator generator;
    private StarRocksCapabilityProvider capabilityProvider;

    @BeforeEach
    void setUp() {
        capabilityProvider = new StarRocksCapabilityProvider();
        generator = new StarRocksMetadataQueryGenerator(capabilityProvider);
    }
