...
/**
 * StarRocks metadata query generator.
 * 
 * <p>
 * Generates SQL queries for retrieving StarRocks metadata from information_schema.
 * 
 * @since 1.0.0
 */
public class StarRocksMetadataQueryGenerator extends BaseMetadataQueryGenerator {

    private final CapabilityProvider capabilityProvider;

    public StarRocksMetadataQueryGenerator(CapabilityProvider capabilityProvider) {
    ...
    public String getSchemasSQL() {
        return "SELECT schema_name FROM information_schema.schemata " +
                "WHERE schema_name NOT IN ('information_schema', 'starrocks', 'performance_schema', 'sys') " +
