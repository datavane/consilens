...
/**
 * Unit tests for MySQLMetadataQueryGenerator.
 */
class MySQLMetadataQueryGeneratorTest {

    private MySQLMetadataQueryGenerator generator;
    private MySQLCapabilityProvider capabilityProvider;

    @BeforeEach
    void setUp() {
        capabilityProvider = new MySQLCapabilityProvider();
        generator = new MySQLMetadataQueryGenerator(capabilityProvider);
    }
