...
/**
 * Presto metadata query generator.
 * Presto uses information_schema for metadata.
 */
public class PrestoMetadataQueryGenerator extends BaseMetadataQueryGenerator {

    private final CapabilityProvider capabilityProvider;

    public PrestoMetadataQueryGenerator(CapabilityProvider capabilityProvider) {
    ...
    public String getPrimaryKeysSQL(String schemaName, String tableName) {
        // Presto doesn't have primary key constraints in information_schema
    ...
    public String getIndexesSQL(String schemaName, String tableName) {
        // Presto doesn't have traditional indexes
    ...
    public String getOptimizeTableSQL(String schemaName, String tableName) {
        // Presto doesn't have OPTIMIZE TABLE
        return "-- No optimize for Presto";
    }
