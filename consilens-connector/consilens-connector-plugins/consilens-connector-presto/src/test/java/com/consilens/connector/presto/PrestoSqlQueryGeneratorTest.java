...
class PrestoSqlQueryGeneratorTest {

    private PrestoSqlQueryGenerator generator;
    private PrestoCapabilityProvider capabilityProvider;
    private PrestoDataTypeHandler dataTypeHandler;

    @BeforeEach
    void setUp() {
        capabilityProvider = new PrestoCapabilityProvider();
        dataTypeHandler = new PrestoDataTypeHandler(capabilityProvider);
        generator = new PrestoSqlQueryGenerator(capabilityProvider, dataTypeHandler);
    }
