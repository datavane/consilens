...
/**
 * Doris metadata query generator.
 * 
 * <p>
 * Generates SQL queries for retrieving Doris metadata from information_schema.
 * 
 * @since 1.0.0
 */
public class DorisMetadataQueryGenerator extends BaseMetadataQueryGenerator {

    private final CapabilityProvider capabilityProvider;

    public DorisMetadataQueryGenerator(CapabilityProvider capabilityProvider) {
    ...
    public String getSchemasSQL() {
        return "SELECT schema_name FROM information_schema.schemata " +
                "WHERE schema_name NOT IN ('information_schema', 'doris', 'performance_schema', 'sys') " +
