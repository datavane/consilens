...
/**
 * Unit tests for DorisSqlQueryGenerator.
 */
class DorisSqlQueryGeneratorTest {

    private DorisSqlQueryGenerator generator;
    private DorisCapabilityProvider capabilityProvider;
    private DorisDataTypeHandler dataTypeHandler;

    @BeforeEach
    void setUp() {
        capabilityProvider = new DorisCapabilityProvider();
        dataTypeHandler = new DorisDataTypeHandler(capabilityProvider);
        generator = new DorisSqlQueryGenerator(capabilityProvider, dataTypeHandler);
    }
